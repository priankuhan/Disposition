defmodule TeamOrganization.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import TeamOrganization.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&TeamOrganization.ErrorHelpers.translate_error/1)
